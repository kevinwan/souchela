# -*- coding: utf-8 -*-
# Django settings for souche project.
...
ADMINS = (
    ('Jinliang Zhu', 'jl_zhu@foxmail.com'),
    ('Xiang He', 'xhe@gongpingjia.com'),
)
...
SECRET_KEY = '#x&amp;1cgv+7g+c*f95w6#0+^n&amp;kj8ad8%=m9!e#ez7s3gp2a97lk'
...
MIDDLEWARE_CLASSES = (
    ...
    'souche.apps.core.middlewares.EnsureCsrfCookieMiddleware',
)

ROOT_URLCONF = 'souche.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'souche.wsgi.application'
